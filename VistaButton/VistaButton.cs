...
public class VistaButton : System.Windows.Forms.UserControl
    ...
    private Color mHighlightColor = System.Drawing.ColorTranslator.FromHtml("#3399FF");
    /// <summary>
    /// The colour of the highlight on the top of the button.
    /// </summary>
    [Category("Appearance"),
     DefaultValue(typeof(Color), "#3399FF"),
    ...
    private Color mButtonColor = System.Drawing.ColorTranslator.FromHtml("#003399");
    /// <summary>
    /// The bottom color of the button that 
    /// will be drawn over the base color.
    /// </summary>
    [Category("Appearance"),
     DefaultValue(typeof(Color), "#003399"),
    ...
    private Color mGlowColor = System.Drawing.ColorTranslator.FromHtml("#0033CC");
    /// <summary>
    /// The colour that the button glows when
    /// the mouse is inside the client area.
    /// </summary>
    [Category("Appearance"),
     DefaultValue(typeof(Color), "#0033CC"),
    ...
    private Color mBaseColor = System.Drawing.ColorTranslator.FromHtml("#003399");
    /// <summary>
    ...
    /// <summary>
    /// Activacion o Desactivacion del control.
    /// </summary>
    [Category("Appearance"),
     DefaultValue(typeof(Boolean), "True"),
     Description("Activacion o Desactivacion del control.")]
    public bool Enabled
        {
        ...
        set
            ...
            if (base.Enabled == true)
                {
                this.mButtonColor = System.Drawing.ColorTranslator.FromHtml("#003399");
                this.mGlowColor = System.Drawing.ColorTranslator.FromHtml("#0033CC");
                this.mHighlightColor = System.Drawing.ColorTranslator.FromHtml("#3399FF");
                this.mBaseColor = System.Drawing.ColorTranslator.FromHtml("#003399");
                }
            else
                {
                this.mButtonColor = System.Drawing.ColorTranslator.FromHtml("#666666");
                this.mGlowColor = System.Drawing.ColorTranslator.FromHtml("#999999");
                this.mHighlightColor = System.Drawing.ColorTranslator.FromHtml("#E2E2E2");
                this.mBaseColor = System.Drawing.Color.Transparent;
                }
            this.Invalidate();
            }
        }
    ...
    public VistaButton()
        ...
        try
            {
            oht = DBDriver.HashTableSection.ReadConfig("NetSilverVistaButton");
            this.BaseColor = System.Drawing.ColorTranslator.FromHtml(
                oht["ColorBase"].ToString());
            this.ForeColor = System.Drawing.ColorTranslator.FromHtml(
                oht["ColorTexto"].ToString());
            }
        catch
        { }
